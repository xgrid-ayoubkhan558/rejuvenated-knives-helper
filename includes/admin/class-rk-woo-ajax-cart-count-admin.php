...
final class RK_Woo_Ajax_Cart_Count_Admin
{
    ...
    public static function register_settings()
    {
        ...
        // The checkout fields options array
        register_setting(
            'rk_woo_ajax_cart_count_settings',
            'rk_cf_options',
            array(
    ...
    public static function page()
    {
        ...
        ?>
        <div class="wrap" id="rk-settings-wrap">
            <h1>Rejuvenated Knives Helper Settings</h1>

            <h2 class="nav-tab-wrapper">
                <a href="#general" class="nav-tab nav-tab-active" data-tab="general">General & Cart</a>
                <a href="#checkout_tweaks" class="nav-tab" data-tab="checkout_tweaks">Checkout Tweaks</a>
                <a href="#dynamic_fields" class="nav-tab" data-tab="dynamic_fields">Dynamic Fields</a>
                <a href="#messages_labels" class="nav-tab" data-tab="messages_labels">Messages & Labels</a>
            </h2>
            ...
            <form method="post" action="options.php">
                ...
                <!-- Tab: General -->
                <div id="tab-general" class="rk-tab-content">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="rk_woo_ajax_cart_count_min_order_value" id="rk_woo_ajax_cart_count_min_order_value"
                                    ...
                                    value="<?php echo esc_attr($options['min_order_value']); ?>" class="regular-text" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input name="rk_woo_ajax_cart_count_minimum_formula" id="rk_woo_ajax_cart_count_minimum_formula"
                                    type="text" value="<?php echo esc_attr($options['minimum_formula']); ?>"
                                    class="regular-text" />
                    ...
                    <table class="form-table" role="presentation">
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input name="rk_enable_advanced_pickup_columns" type="checkbox" value="1" <?php checked(1, $options['pickup_columns']); ?> /> Styled Pickup Days in Locations
                                    admin</label>
                            </td>
                        </tr>
                    </table>
                ...
                <!-- Tab: Checkout Tweaks -->
                <div id="tab-checkout_tweaks" class="rk-tab-content rk-hidden">
                    ...
                    <table class="form-table" role="presentation">
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input name="rk_rename_billing_to_delivery" type="checkbox" value="1" <?php checked(1, $options['rename_billing']); ?> /> Rename "Billing" to "Delivery" across
                                    checkout</label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input name="rk_us_phone_validation" type="checkbox" value="1" <?php checked(1, $options['us_phone_validation']); ?> /> Enforce (555-123-4567) format and min 6
                                    digits</label>
                            </td>
                        </tr>
                        <tr>
                ...
                <!-- Tab: Dynamic Fields -->
                <div id="tab-dynamic_fields" class="rk-tab-content rk-hidden">
                    <h2 class="title">Dynamic Field Logic</h2>
                    <table class="form-table" role="presentation">
                        <tr>
                            <th scope="row">Auto Payment Selection</th>
                            <td>
                                <label><input type="checkbox" name="rk_cf_options[enable_auto_payment]" value="1" <?php checked(1, $cf_options['enable_auto_payment']); ?> /> Automatically select payment
                                    method based on city availability</label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <input type="text" name="rk_cf_options[payment_found]"
                                        value="<?php echo esc_attr($cf_options['payment_found']); ?>" class="regular-text" />
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($payment_methods)): ?>
                                    <select name="rk_cf_options[payment_not_found]" class="regular-text">
                                        <option value="">-- Select Payment Method --</option>
                                        <?php foreach ($payment_methods as $id => $title): ?>
                                            <option value="<?php echo esc_attr($id); ?>" <?php selected($cf_options['payment_not_found'], $id); ?>><?php echo esc_html($title); ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                <?php else: ?>
                                    <input type="text" name="rk_cf_options[payment_not_found]"
                                        value="<?php echo esc_attr($cf_options['payment_not_found']); ?>" class="regular-text" />
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <label><input type="checkbox" name="rk_cf_options[require_city_selection]" value="1" <?php checked(1, $cf_options['require_city_selection']); ?> /> Require city selection from
                                    dropdown only</label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="checkbox" name="rk_cf_options[add_body_classes]" value="1" <?php checked(1, $cf_options['add_body_classes']); ?> /> Add CSS classes to body element (rk-city-found,
                                    etc.)</label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="rk_cf_options[date_format]"
                                    value="<?php echo esc_attr($cf_options['date_format']); ?>" class="regular-text" />
                        ...
                        <tr>
                            ...
                            <td>
                                Min: <input type="number" name="rk_cf_options[min_days_advance]"
                                    value="<?php echo esc_attr($cf_options['min_days_advance']); ?>" class="small-text"
                                    min="0" />
                                Max: <input type="number" name="rk_cf_options[max_days_advance]"
                                    value="<?php echo esc_attr($cf_options['max_days_advance']); ?>" class="small-text"
                                    min="1" />
                            </td>
                        </tr>
                    </table>
                ...
                <!-- Tab: Messages & Labels -->
                <div id="tab-messages_labels" class="rk-tab-content rk-hidden">
                    <h2 class="title">Field Labels</h2>
                    <table class="form-table" role="presentation">
                        <tr>
                            <th scope="row">Region Label</th>
                            <td><input type="text" name="rk_cf_options[region_label]"
                                    value="<?php echo esc_attr($cf_options['region_label']); ?>" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th scope="row">City Search Label</th>
                            <td><input type="text" name="rk_cf_options[city_search_label]"
                                    value="<?php echo esc_attr($cf_options['city_search_label']); ?>" class="regular-text" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Pickup Date Label</th>
                            <td><input type="text" name="rk_cf_options[pickup_date_label]"
                                    value="<?php echo esc_attr($cf_options['pickup_date_label']); ?>" class="regular-text" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Search Placeholder</th>
                            <td><input type="text" name="rk_cf_options[city_search_placeholder]"
                                    value="<?php echo esc_attr($cf_options['city_search_placeholder']); ?>"
                    ...
                    <table class="form-table" role="presentation">
                        <tr>
                            ...
                            <td><textarea name="rk_cf_options[mailin_message]" rows="5"
                                    class="large-text"><?php echo esc_textarea($cf_options['mailin_message']); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">City found message</th>
                            <td><textarea name="rk_cf_options[city_found_message]" rows="4"
                                    class="large-text"><?php echo esc_textarea($cf_options['city_found_message']); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">City selected message</th>
                            <td><textarea name="rk_cf_options[city_selected_message]" rows="4"
                                    class="large-text"><?php echo esc_textarea($cf_options['city_selected_message']); ?></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        <script>
            jQuery(document).ready(function ($) {
                $('#rk-settings-wrap .nav-tab').on('click', function (e) {
                    e.preventDefault();
                    ...
                    $('.rk-tab-content').addClass('rk-hidden');
                    $('#tab-' + tabId).removeClass('rk-hidden');

                    // Store last tab in hash for refresh persistence
                    window.location.hash = tabId;
                });

                // Persistence: stay on tab after refresh/save
